...
import com.take_photo.adapter.GridImageAdapter;
...
public class TakingPhotoActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private final static String TAG = TakingPhotoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taking_photo2);
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(TakingPhotoActivity.this, 4, GridLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(manager);
        adapter = new GridImageAdapter(TakingPhotoActivity.this, onAddPicClickListener);
...
//                        PictureSelector.create(TakingPhotoActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
//                        break;
//                    case 2:
//                        // 预览视频
//                        PictureSelector.create(TakingPhotoActivity.this).externalPictureVideo(media.getPath());
//                        break;
//                    case 3:
//                        // 预览音频
//                        PictureSelector.create(TakingPhotoActivity.this).externalPictureAudio(media.getPath());
//                        break;
//                }
//            }
//        });
        ...
        permissions.request(Manifest.permission.WRITE_EXTERNAL_STORAGE).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(TakingPhotoActivity.this);
                } else {
                    Toast.makeText(TakingPhotoActivity.this,
    ...
    private GridImageAdapter.onAddPicClickListener onAddPicClickListener = new GridImageAdapter.onAddPicClickListener() {
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(TakingPhotoActivity.this)
