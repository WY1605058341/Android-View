...
import com.android_view.utils.SizeUtil;
...
public class WatchBoard extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        try {
            array = getContext().obtainStyledAttributes(attrs, R.styleable.WatchBoard); //获取自定义参数值
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(width, width); //设置 自定义view的宽高
