...
import com.hkx.zxinglibrary.CaptureCallback;
import com.hkx.zxinglibrary.camera.CameraManager;
import com.hkx.zxinglibrary.decode.DecodeThread;
import com.hkx.zxinglibrary.utils.CaptureActivityHandler;
import com.hkx.zxinglibrary.utils.InactivityTimer;
import com.qrcode.utils.BeepManager;
import com.qrcode.utils.Utils;

import java.io.IOException;

public class CaptureActivity extends AppCompatActivity implements CaptureCallback, SurfaceHolder.Callback {

    private static final String TAG = "CaptureActivity";

    private SurfaceView scanPreview; // SurfaceView控件
    private LinearLayout scanContainer; // 布局容器
